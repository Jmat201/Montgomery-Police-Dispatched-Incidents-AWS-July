...
select priority,initial_type
    , 0 as ACM_SILVER_SPRING
    , Avg_dispatch_min as ACM_ROCKVILLE
    , 0 as ACM_GAITHERSBURG
    , 0 as ACM_GERMANTOWN
    , 0 as count_germantown
...
select priority,initial_type
    , 0 as ACM_SILVER_SPRING
    , 0 as ACM_ROCKVILLE
    , Avg_dispatch_min as ACM_GAITHERSBURG
    , 0 as ACM_GERMANTOWN
    , 0 as count_germantown
    , 0 as count_rockville
...
select priority,initial_type
    ...
    , 0 as ACM_ROCKVILLE
    , 0 as ACM_GAITHERSBURG
    , Avg_dispatch_min as ACM_GERMANTOWN
    , 0 as count_germantown
    , 0 as count_rockville
    , 0 as count_gaithersburg
