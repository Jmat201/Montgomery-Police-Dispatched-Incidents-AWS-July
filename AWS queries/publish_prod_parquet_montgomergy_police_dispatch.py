...
QUERY_RESULTS_BUCKET = 's3://athena-query-results-bucket-may-2024-jeff/'
MY_DATABASE = 'de_project_database'
SOURCE_PARQUET_TABLE_NAME = 'montgomery_police_inc_data_parquet_tbl'
NEW_PROD_PARQUET_TABLE_NAME = 'montgomery_police_inc_data_parquet_tbl_PROD'
NEW_PROD_PARQUET_TABLE_S3_BUCKET = 's3://montgomery-police-inc-tbl-pqt/'
