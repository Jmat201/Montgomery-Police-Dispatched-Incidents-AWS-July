...
BUCKET_TO_DEL = 'montgomery-police-inc-tbl-pqt'
DATABASE_TO_DEL = 'de_project_database'
TABLE_TO_DEL = 'montgomery_police_inc_data_parquet_tbl'
QUERY_OUTPUT_BUCKET = 's3://athena-query-results-bucket-may-2024-jeff/'
